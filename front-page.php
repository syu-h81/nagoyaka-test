          ...
          <div class="p-top-hero__body__checks">
            <div class="p-top-hero__body__check">
              <div class="p-top-hero__body__check__icon">
                <img src="<?php echo get_template_directory_uri()?>/assets/images/check-icon-yellow.png" alt="">
              </div>
      ...
      <div class="p-top-flow__block">
        ...
        <div class="p-top-flow__step__inner">
          ...
          <div class="p-top-flow__step">
            <div class="p-top-flow__step__img__inner">
              <div class="p-top-flow__step__img">
                <img src="<?php echo get_template_directory_uri()?>/assets/images/top-flow-1.png" alt="">
              </div>
          ...
          <div class="p-top-flow__step">
            <div class="p-top-flow__step__img__inner">
              <div class="p-top-flow__step__img">
                <img src="<?php echo get_template_directory_uri()?>/assets/images/top-flow-2.png" alt="">
              </div>
              <div class="p-top-flow__step__img__text">
          ...
          <div class="p-top-flow__step">
            <div class="p-top-flow__step__img__inner">
              <div class="p-top-flow__step__img">
                <img src="<?php echo get_template_directory_uri()?>/assets/images/top-flow-3.png" alt="">
              </div>
              <div class="p-top-flow__step__img__text">
          ...
          <div class="p-top-flow__step">
            <div class="p-top-flow__step__img__inner">
              <div class="p-top-flow__step__img">
                <img src="<?php echo get_template_directory_uri()?>/assets/images/top-flow-4.png" alt="">
              </div>
              <div class="p-top-flow__step__img__text">
